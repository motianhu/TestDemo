...
public class GalleryFlow extends Gallery {
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
        ...
        rotationAngle = ((float) (mCoveflowCenter - childCenter) / childWidth)
                * mMaxRotationAngle;
     ...
     */
    private void transformImageBitmap(BorderImageView child, Transformation t,
            float rotationAngle) {
        mCamera.save();
        ...
        float scale = this.getContext().getResources()
                .getInteger(R.integer.gallery_scale) / 10.0f;

        mCamera.translate((float) (rotationAngle * 2.8 * scale),
                (float) (rotation * 0.1), zoomAmount);

        // 设置透明度
        child.setAlpha((int) (255 - 255 * 0.1 * Math.pow(rotation
                / mMaxRotationAngle, 2)));
    ...
    public void moveNext() {
        try {
            ...
            Class<Gallery> c = (Class<Gallery>) Class
                    .forName("android.widget.Gallery");
